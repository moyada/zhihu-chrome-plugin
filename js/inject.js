...
// document.getElementsByClassName('QuestionWaiting-questions')[0].childElementCount

// document.getElementsByClassName('QuestionWaiting-questions')[0].addEventListener("DOMAttrModified", function(){
